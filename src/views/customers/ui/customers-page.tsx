...
// Simple mock data to render the table as in the design
const rows = [
  {
    date: "16/08/2013",
    name: "Binford Ltd.",
          ...
          <CardContent className="p-0">
            ...
            <div>
              {rows.map((r, i) => (
                <div
                  key={i}
                  onClick={() => router.push(`/dashboard/customers/${encodeURIComponent(r.id)}`)}
                  className="grid cursor-pointer grid-cols-[160px_280px_160px_280px_1fr] items-center border-b border-[#eff2f5] text-[14px] text-[#2d3145] transition-colors hover:bg-emerald-50/60"
                >
